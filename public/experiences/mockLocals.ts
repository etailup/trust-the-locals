...
export const mockChefs: Local[] = [
  {
    ...
    image: '/locals/chef_3.jpg',
    media: [
      { type: 'image', src: '/locals/chef_3.jpg' },
  ...
  },
  {
    ...
    image: '/locals/chef_2.jpg',
    media: [
      { type: 'image', src: '/locals/chef_2.jpg' },
  ...
  },
  {
    ...
    image: '/locals/chef_1.jpg',
    media: [
      { type: 'image', src: '/locals/chef_1.jpg' },
...
export const mockSecurity: Local[] = [
  ...
  },
  {
    ...
    image: '/locals/bodyguard_5.jpg',
    media: [
      { type: 'image', src: '/locals/bodyguard_5.jpg' },
      { type: 'video', src: '/locals/Bodyguard_Elyon.mp4' },
    ],
  ...
  },
  {
    ...
    image: '/locals/bodyguard_4.jpg',
    media: [
      { type: 'image', src: '/locals/bodyguard_4.jpg' },
      { type: 'video', src: '/locals/Bodyguard_Cosimo.mp4' },
    ],
  ...
  },
  {
    ...
    image: '/locals/bodyguard_1.jpg',
    media: [
      { type: 'image', src: '/locals/bodyguard_1.jpg' },
      { type: 'video', src: '/locals/Bodyguard_Alessandro.mp4' },
    ],
  ...
  },
  {
    ...
    image: '/locals/bodyguard_3.jpg',
    media: [
      { type: 'image', src: '/locals/bodyguard_3.jpg' },
      { type: 'video', src: '/locals/Bodyguard_Kuelly.mp4' },
    ],
    specialties: ['Personal Security', 'Risk Management'],
    availability: 'Available upon request',
    languages: ['English', 'French'],
...
export const mockTrainers: Local[] = [
  {
    ...
    image: '/locals/pilates.jpg',
    media: [
      { type: 'image', src: '/locals/pilates.jpg' },
  ...
  },
  {
    ...
    image: '/locals/PT_boxing.jpg',
    media: [
      { type: 'image', src: '/locals/PT_boxing.jpg' },
  ...
  },
  {
    ...
    image: '/locals/pt_fitness.jpg',
    media: [
      { type: 'image', src: '/locals/pt_fitness.jpg' },
...
export const mockGuides: Local[] = [
  {
    ...
    description: 'Born and raised in Florence. Passionate storyteller and local expert.',
    fullDescription: 'Born and raised in Florence. Passionate storyteller and local expert.',
    image: '/locals/PC_3.jpg',
    media: [
      { type: 'image', src: '/locals/PC_3.jpg' },
      { type: 'video', src: '/locals/Personal_Concierge_Claudia.mp4' },
    ],
    specialties: ['Storytelling', 'Local Expertise'],
    availability: 'Available upon request',
    languages: ['English', 'French', 'Spanish'],
    cropX: 20,
    cropY: 11,
...
export const mockDrivers: Local[] = [
  {
    ...
    image: '/locals/driver_3.jpg',
    media: [
      { type: 'image', src: '/locals/driver_3.jpg' },
      { type: 'video', src: '/locals/Driver Alessandro (1).mp4' },
    ],
    specialties: ['Driver'],
    availability: 'Available upon request',
    languages: ['English', 'French'],
  ...
  },
  {
    ...
    image: '/locals/driver_4.jpg',
    media: [
      { type: 'image', src: '/locals/driver_4.jpg' },
      { type: 'video', src: '/locals/Driver Guido (1).mp4' },
    ],
    specialties: ['Driver'],
    availability: 'Available upon request',
    languages: ['English'],
  ...
  },
  {
    ...
    image: '/locals/driver_7.jpg',
    media: [
      { type: 'image', src: '/locals/driver_7.jpg' },
      { type: 'video', src: '/locals/Driver Matteo (1).mp4' },
    ],
    specialties: ['Driver'],
    availability: 'Available upon request',
    languages: ['English', 'Spanish'],
  ...
  },
  {
    ...
    image: '/locals/driver_8.jpg',
    media: [
      { type: 'image', src: '/locals/driver_8.jpg' },
      { type: 'video', src: '/locals/Driver Jacopo (1).mp4' },
    ],
    specialties: ['Driver'],
    availability: 'Available upon request',
    languages: ['English', 'French', 'Spanish'],
  ...
  },
  {
    ...
    image: '/locals/driver_1.jpg',
    media: [
      { type: 'image', src: '/locals/driver_1.jpg' },
      { type: 'video', src: '/locals/Driver Giulio (1).mp4' },
    ],
    specialties: ['Driver'],
    availability: 'Available upon request',
    languages: ['English'],
  ...
  },
  {
    ...
    image: '/locals/driver_5.jpg',
    media: [
      { type: 'image', src: '/locals/driver_5.jpg' },
      { type: 'video', src: '/locals/Driver Tommaso (1).mp4' },
    ],
    specialties: ['Driver'],
    availability: 'Available upon request',
    languages: ['English', 'Spanish'],
  ...
  },
  {
    ...
    image: '/locals/driver_2.jpg',
    media: [
      { type: 'image', src: '/locals/driver_2.jpg' },
      { type: 'video', src: '/locals/Driver Niccolò (1).mp4' },
    ],
    specialties: ['Driver'],
    availability: 'Available upon request',
    languages: ['English', 'French'],
  ...
  },
  {
    ...
    image: '/locals/driver_6.jpg',
    media: [
      { type: 'image', src: '/locals/driver_6.jpg' },
...
export const mockConcierges: Local[] = [
  {
    ...
    image: '/locals/PC_2.jpg',
    media: [
      { type: 'image', src: '/locals/PC_2.jpg' },
  ...
  },
  {
    ...
    image: '/locals/PC_3.jpg',
    media: [{ type: 'image', src: '/locals/PC_3.jpg' }],
...
export const mockMassageTherapists: Local[] = [
  {
    ...
    image: '/locals/massaggiatrice_2.jpg',
    media: [{ type: 'image', src: '/locals/massaggiatrice_2.jpg' }],
    specialties: ['Massage'],
    availability: 'Available upon request',
  ...
  },
  {
    ...
    image: '/locals/massaggiatrice_1.jpg',
    media: [{ type: 'image', src: '/locals/massaggiatrice_1.jpg' }],
    specialties: ['Massage'],
    availability: 'Available upon request',
    languages: ['Italian', 'English'],
    cropX: defaultCropX,
...
export const mockPhysiotherapists: Local[] = [
  {
    ...
    image: '/locals/fisioterapista.jpg',
    media: [{ type: 'image', src: '/locals/fisioterapista.jpg' }],
    specialties: [],
    availability: 'Available upon request',
    languages: [],
    cropX: defaultCropX,
