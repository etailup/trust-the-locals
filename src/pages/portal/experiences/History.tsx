...
const History = () => {
  const historyExperiences = visibleMockExperiences.filter(exp => 
    exp.category === 'Private Tours' || exp.category === 'Cultural'
  );
      ...
      <main className="md:ml-10 flex-1 p-8">
        <div className="mb-12 animate-fade-up">
          ...
          <p className="text-portal-navy/60">
            Exclusive access to heritage and cultural treasures
          </p>
