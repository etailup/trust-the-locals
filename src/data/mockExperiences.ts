...
export const mockExperiences: Experience[] = [
  ...
  },
  {
    ...
    longDescription: `An extraordinary gastronomic experience dedicated to Florentine culinary tradition in the heart of the Oltrarno district, within the prestigious Palazzo Guicciardini, a historic noble residence overlooking Piazza Pitti.

The experience begins among the artisan workshops and most famous markets of the historic center, where guests select the most authentic ingredients in consultation with the chef.

Once the shopping is complete (optional), the lesson will focus on creating the recipes that have formed the foundation of our tradition, in a convivial, private, and tranquil atmosphere.
You will be guided by a young Florentine chef, who prides himself on our regional culinary tradition, successfully enhancing the flavors and ingredients of simple, historic recipes.

Immerse yourself in an experience that will leave you not only with wonderful memories, but above all, a new understanding of the city, through what you'll prepare and taste with your private chef.

Recommended activity for families and private groups.`,
...
export const visibleMockExperiences = mockExperiences.filter((experience) => !experience.hidden);
