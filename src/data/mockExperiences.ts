...
export const mockExperiences: Experience[] = [
  // FOOD & WINE
    ...
    category: 'Food & Wine',
    description: 'A curated escape designed to reveal Florence from its most evocative viewpoints. This experience combines landscape, history, and perspective, offering a deeper understanding of the city beyond its streets.',
    ...
    featured: true,
    pricing: '€490 for 3 hours (1-2 people)\n+€70 per additional person',
  },
  {
    id: 'hist-3',
    title: 'Artisan Tour',
    ...
    category: 'History',
    description: 'An intimate journey into Florence’s living craftsmanship. Guests enter hidden workshops to witness traditional techniques still practiced today, meeting artisans who shape the city’s cultural identity through their hands.',
    ...
    pricing: 'Starting from €165 per person',
  },

    {
    id: 'fw-4',
    title: 'Cooking Class',
    subtitle: 'In Palazzo Guicciardini',
    category: 'Food & Wine',
    description: 'A hands-on culinary experience rooted in Tuscan tradition. More than a lesson, this is a cultural exchange where recipes are shared alongside stories, techniques, and local knowledge.',
    longDescription: `A refined gastronomic journey set within the historic walls of Palazzo Guicciardini, one of Florence’s most storied aristocratic residences. Located in the heart of the Oltrarno district, this palace offers a grand, authentic backdrop for a deep dive into Tuscan flavors.

The experience begins at the vibrant Mercato Centrale. Alongside your chef, you’ll navigate the historic stalls to hand-select the freshest seasonal ingredients, learning the secrets of local produce.

From the market, you’ll head to the private kitchens of the Palazzo. In this elegant and intimate setting, you’ll engage in a hands-on cooking class, uncovering the techniques behind Florence’s most iconic traditional dishes. The journey concludes with a convivial lunch or dinner, where you will enjoy the fruits of your labor paired with local wines in a truly noble atmosphere.`,
    ...
    pricing: '€235 per person (1-8 guests)',
  },
    ...
    description: 'A slow-paced exploration of Tuscany’s landscapes and villages, designed to connect guests with the rhythm of the territory. Walking becomes a way to observe, listen, and understand.',
    category: 'History',
    ...
    pricing: 'Starting from €300 per person',
  ...
  },
  {
    ...
    category: 'Food & Wine',
    description: 'An introduction to Tuscan wine culture centered on human stories rather than labels. Guests meet winemakers and explore how land, tradition, and vision shape each wine.',
  ...
  },
  {
    ...
    category: 'Food & Wine',
    description: 'A curated food journey through Florence that reveals the city through its flavors. From markets to traditional stops, food becomes a lens into daily life and local identity.',
    ...
    pricing: 'Starting from €450 for 2 people\n+€90 per additional person',
  },
  {
    id: 'fw-7',
    ...
    category: 'Food & Wine',
    description: 'An exclusive dining experience set in one of Florence’s most iconic locations. A moment designed around atmosphere, intimacy, and an exceptional setting.',
    ...
    pricing: 'Starting from €600 for 2 people',
  },
  {
    id: 'fw-10',
    ...
    category: 'Premium',
    description: 'A driving experience through Tuscany’s landscapes, where performance and scenery merge. The journey emphasizes perspective, freedom, and the pleasure of the road.',
...
Whether you choose the Chianti hills or the coastal route, you will experience a journey crafted entirely around you: legendary roads, scenic stops, hidden villages, and a dedicated Local who opens doors and places usually inaccessible to visitors. An experience that blends luxury, speed, and authenticity in true Trust The Locals style`,
    ...
    pricing: 'Starting from €900 per person',
  },

   {
    ...
    category: 'Premium',
    description: 'A refined moment dedicated to well-being and balance. This experience focuses on slowing down and reconnecting with body and mind in a serene Tuscan setting.',
  ...
  },
  {
    ...
    subtitle: 'Dal Leo',
    category: 'Food & Wine',
    description: 'A refined wine experience centered on tasting, place, and perspective in a serene Tuscan setting.',
  ...
  // HISTORY
  {
    ...
    category: 'History',
    description: 'An inside look into the world of art restoration, where heritage is preserved through patience, skill, and scientific knowledge.',
    ...
    pricing: 'Starting from €180 per person',
  },

  {
    ...
    category: 'Premium',
    description: 'An exclusive encounter with the tradition of Florentine goldsmithing. Guests enter a private atelier to discover craftsmanship where precision meets artistry.',
    ...
    availability: 'Year-round, Booking Available within 48h',
    pricing: 'Starting from €1,400 per person',
  },
  ...
  // PREMIUM
  {
    ...
    category: 'Food & Wine',
    description: 'A creative wine experience combining tasting with personal expression. Guests explore wine and then design a custom label, transforming tasting into creation.',
...
Upon request, the experience can conclude with an optional lunch at the winery, accompanied by a dedicated sommelier.`,
    ...
    availability: 'Year-round, Booking Available within 48h',
    featured: true,
    pricing: 'Starting from €195 per person',
  },
  {
    id: 'prem-2',
    ...
    category: 'Premium',
    description: 'A journey through the Mugello region, one of Tuscany’s most authentic territories. Landscapes, villages, and local stories reveal a side of Tuscany far from the usual routes.',
    ...
    featured: true,
    pricing: 'Starting from €1,110 per person',
  },
];
